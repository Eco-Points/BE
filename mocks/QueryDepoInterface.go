...
// QueryDepoInterface is an autogenerated mock type for the QueryDepoInterface type
type QueryDepoInterface struct {
	mock.Mock
}

// DepositTrash provides a mock function with given fields: data
func (_m *QueryDepoInterface) DepositTrash(data deposits.WasteDepositInterface) error {
	ret := _m.Called(data)
...
func (_m *QueryDepoInterface) GetDepositbyId(deposit_id uint) (deposits.WasteDepositInterface, error) {
...
func (_m *QueryDepoInterface) GetUserDeposit(id uint, limit uint, offset uint, is_admin bool) (deposits.ListWasteDepositInterface, error) {
...
func NewQueryDepoInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *QueryDepoInterface {
	mock := &QueryDepoInterface{}
	mock.Mock.Test(t)
